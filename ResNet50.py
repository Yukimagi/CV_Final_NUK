...
with open(CURRENT_DIR_PATH + f"/name.txt", "r") as f:
    name_lines = f.readlines()

with open(CURRENT_DIR_PATH + f"/query.txt", "r") as f:
...
# 建立資料路徑
base_path = CURRENT_DIR_PATH+ f"/pic01/pic"
